...
/** 第一張是預設地圖：跑道（情境測試，之後的新手教學）。射擊場、決鬥場接在後面。 */
export const RAW_MAPS: readonly RawMap[] = [track01 as RawMap, range01 as RawMap, duel01 as RawMap, provingGround as RawMap];
