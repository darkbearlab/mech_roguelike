...
describe('地圖', () => {
  ...
  it('出生點必須在圖內（站在稜線上可以：地形目前不擋路）', () => {
    expect(() => loadMap(RULES, flatRaw(5, 5, [[2, 2, '#']]))).not.toThrow();
    const raw = flatRaw(5, 5);
